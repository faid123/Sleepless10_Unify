...
struct ImGuiStorage
{
    ...
    struct ImGuiStoragePair
    {
        ...
        ImGuiStoragePair(ImGuiID _key, int _val_i)      { val_p = nullptr; key = _key; val_i = _val_i; }
        ImGuiStoragePair(ImGuiID _key, float _val_f)    { val_p = nullptr; key = _key; val_f = _val_f; }
